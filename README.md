...
|percent| процент суммы осадков из `sum_RRR_fact` от среднего показателя `sum_RRR` (все что меньше -25 - малоснежная, положительные - многоснежная)
|decade_sum_RRR_fact| сумма осадков за зиму (зимние месяца), вместо первого и последнего месяцев считаются значения по декадам из decade_start и decade_end
|decade_sum_RRR| сумма осадков за зиму (зимние месяца), вместо первого и последнего месяцев считаются значения по декадам для средняя сумма осадков RRR за последние 10 лет по зимним месяцам метеостанции
|decade_percent| процент суммы осадков из decade_sum_RRR_fact от decade_sum_RRR  (все что меньше -25 - малоснежная, положительные - многоснежная)

Чтобы определить малоснежность зимы, делаем проверку по полю `decade_percent`.

Многие метеостанции не имеют значения осадков, также в поиск не были включены те метеостанции, статистика по которым отстутствует.
Метеостанции, которые не были найдены и причины:
```
...
nan not found file
```
Всего метеостанций - 56шт.
Строк в данных: 162.
Записи, в которых  `decade_percent` больше 25% - 3 шт.
